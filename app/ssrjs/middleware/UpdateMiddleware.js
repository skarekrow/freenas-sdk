...
var UpdateMiddleware = (function (_AbstractBase) {
  function UpdateMiddleware() {
    _classCallCheck(this, UpdateMiddleware);
  ...
  _inherits(UpdateMiddleware, _AbstractBase);

  _createClass(UpdateMiddleware, null, [{
    key: "updatenow",
    value: function updatenow() {
      _MiddlewareClient2["default"].request("task.submit", ["update.update", ""]);
    }
  }]);
...
//# sourceMappingURL=UpdateMiddleware.js.map